...
`app/services/processor.py`. The mock processing endpoint remains available
for the backend contract, while the image-processing endpoint runs Member 2's
quality and enhancement pipeline.
